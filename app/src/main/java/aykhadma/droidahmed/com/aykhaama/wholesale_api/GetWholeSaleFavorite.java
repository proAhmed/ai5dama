 ...
 */
public class GetWholeSaleFavorite extends AsyncTask<String,Void,WholeSaleProductListMain> {
    private ProgressDialog dialog;
     String finalUrl;
    private OnLoadingComplete callback;
    private Context context;
    String responseJSON;
    public GetWholeSaleFavorite(Context context, OnLoadingComplete cb) {
        dialog = new ProgressDialog(context);
        callback = cb;
        this.context = context;
        finalUrl =   "http://ai5adma.com/API/ar/wswishlist?token="+ new StoreData(context).getToken();
