...
public class GetWholeSaleRelated extends AsyncTask<String, Void, WholeSaleProductListMain> {

	private   String URL =  "http://ai5adma.com/API/ar/wsproduct/related/";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetWholeSaleRelated(Context context, OnLoadingComplete cb, double id) {
