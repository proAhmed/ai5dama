...
public class AddCartItemShopping extends AsyncTask<ItemJson, Void, ResponseAddProduct> {
	...
	public AddCartItemShopping(Context context, OnLoadingComplete cb) {
		dialog = new ProgressDialog(context);
		callback = cb;
		this.context = context;
		url = "http://ai5adma.com/API/ar/cart/add?token="+new StoreData(context).getToken();
		Log.d("oooo3",url);
	}
	...
	@Override
	protected ResponseAddProduct doInBackground(ItemJson... params) {
