...
public class ShowCartItemWholeSale extends AsyncTask<JSONArray, Void, CartItemResponse> {

	private final static String URL = "http://ai5adma.com/API/ar/wscart";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public ShowCartItemWholeSale(Context context, OnLoadingComplete cb) {
