...
public class GetWholeSaleCategory extends AsyncTask<String, Void, WholeSaleCategoryMain> {

	private   String URL =  "http://ai5adma.com/API/ar/wsproduct/topcategories";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetWholeSaleCategory(Context context, OnLoadingComplete cb, double num) {
