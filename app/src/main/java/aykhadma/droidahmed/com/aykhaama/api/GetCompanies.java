...
public class GetCompanies extends AsyncTask<String, Void, CompaniesMain> {

	private   String URL =  "http://ai5adma.com/API/ar/company";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetCompanies(Context context, OnLoadingComplete cb) {
