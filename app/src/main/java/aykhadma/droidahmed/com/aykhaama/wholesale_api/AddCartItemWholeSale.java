...
public class AddCartItemWholeSale extends AsyncTask<ItemJson, Void, ResponseAddProduct> {
	...
	public AddCartItemWholeSale(Context context, OnLoadingComplete cb) {
