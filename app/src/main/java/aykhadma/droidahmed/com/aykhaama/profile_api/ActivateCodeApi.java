...
public class ActivateCodeApi extends AsyncTask<String, Void, changePassMain> {

 	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;
  String finalUrl ;
	public ActivateCodeApi(Context context, OnLoadingComplete cb) {
	...
	protected void onPostExecute(changePassMain result) {
 	...
 	public  String makeRequest(String userName,String code) throws Exception {

		DefaultHttpClient httpclient = new DefaultHttpClient();


		HttpPost httpPost = new HttpPost("http://vente1paris.com/API/fr/profile/activeuser");
