 ...
 */
public class ShoppingCategoryItems {
   ...
   private String Picture;
    ...
    public ShoppingCategoryItems() {
    }

    public ShoppingCategoryItems(int ID, String parentID, int level, String picture, int sortingOrder,
