...
public class GetOffer extends AsyncTask<String, Void, OfferMain> {

	private   String URL =  "http://ai5adma.com/API/ar/offer_show";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetOffer(Context context, OnLoadingComplete cb) {
	...
	@Override
	protected void onPostExecute(OfferMain result) {
		if (dialog.isShowing()) {
			dialog.dismiss();
		}
		if (result != null) {
