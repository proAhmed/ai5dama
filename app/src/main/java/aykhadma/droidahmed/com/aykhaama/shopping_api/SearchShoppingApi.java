 ...
 */
public class SearchShoppingApi extends AsyncTask<String,Void,ShoppingProductListMain> {
    private ProgressDialog dialog;
    private final static String URL =  "http://ai5adma.com/API/ar/product/search?q=";
    private OnLoadingComplete callback;
    private Context context;
    String finalUrl;
    public SearchShoppingApi(Context context, OnLoadingComplete cb, String word) {
