...
public class CartQuantity implements Serializable{
    ...
    public CartQuantity(int ID, int cQuantity) {
        this.ID = ID;
    ...
    public CartQuantity(int ID, double code, double categoryID, double brandID, double oldPrice,
                        double price, double quantity, String picture,Object sliderPictures, String createdDate,
    ...
    public CartQuantity(int ID, double code, double categoryID, double brandID, double oldPrice,
                        double price, double quantity, String picture, ArrayList<String> sliderPictures, String createdDate,
                        String modifiedDate, int viewed, int featured, int state, int productID, int languageID,
                        String name, String alias, String contents, String description, String keywords, String categoryName,
    ...
    public CartQuantity(int ID, double code, double categoryID,
                        ...
                        String picture, ArrayList<String> sliderPictures, String createdDate,
    ...
    public CartQuantity(int ID, double code, double categoryID, double brandID,
                        double oldPrice, double price, double quantity, String picture, Object sliderPictures, String createdDate, String modifiedDate, int viewed, int featured, int state, int productID, int languageID, String name, String alias, String contents, String description, String keywords, String categoryName, String brandName, int cQuantity) {
        this.ID = ID;
        Code = code;
        CategoryID = categoryID;
        BrandID = brandID;
    ...
    public void setSliderPictures(Object sliderPictures) {
        SliderPictures = sliderPictures;
    }
