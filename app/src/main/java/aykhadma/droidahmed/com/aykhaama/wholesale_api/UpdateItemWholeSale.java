...
public class UpdateItemWholeSale extends AsyncTask<ItemJson, Void, DeleteProduct> {
	...
	public UpdateItemWholeSale(Context context, OnLoadingComplete cb) {
		dialog = new ProgressDialog(context);
		callback = cb;
		this.context = context;
		url = "http://ai5adma.com/API/ar/wscart/update_quantity?token="+new StoreData(context).getToken();
		Log.d("uuuooo0",url);
	}
