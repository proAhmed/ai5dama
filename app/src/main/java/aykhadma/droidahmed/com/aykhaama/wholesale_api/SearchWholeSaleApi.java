 ...
 */
public class SearchWholeSaleApi extends AsyncTask<String,Void,WholeSaleProductListMain> {
    private ProgressDialog dialog;
    private final static String URL =  "http://ai5adma.com/API/ar/wsproduct/search?q=";
    private OnLoadingComplete callback;
    private Context context;
    String finalUrl;
    public SearchWholeSaleApi(Context context, OnLoadingComplete cb, String word) {
    ...
    @Override
    protected void onPostExecute(WholeSaleProductListMain responseHome) {
