 ...
 */
public class WholeSaleProductListItem implements Parcelable{
    ...
    public WholeSaleProductListItem() {
    }

    public WholeSaleProductListItem(int ID, Object code, int categoryID, int brandID, double price, int quantity,
    ...
    protected WholeSaleProductListItem(Parcel in) {
        ID = in.readInt();
        Code = in.readInt();
    ...
    public static final Creator<WholeSaleProductListItem> CREATOR = new Creator<WholeSaleProductListItem>() {
        @Override
        public WholeSaleProductListItem createFromParcel(Parcel in) {
            return new WholeSaleProductListItem(in);
        }

        @Override
        public WholeSaleProductListItem[] newArray(int size) {
            return new WholeSaleProductListItem[size];
        }
    };
