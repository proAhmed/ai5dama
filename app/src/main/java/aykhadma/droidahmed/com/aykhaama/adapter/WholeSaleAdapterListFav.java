 ...
 */
public class WholeSaleAdapterListFav extends RecyclerView
        .Adapter<WholeSaleAdapterListFav
        .DataObjectHolder> {
    ...
    public WholeSaleAdapterListFav(ArrayList<WholeSaleProductListItem> myDataset, Activity context,
                                   OnWholeSaleClick onWholeSaleClick) {
