 ...
 */
public class ShoppingProductListAdapter extends RecyclerView
        .Adapter<ShoppingProductListAdapter
        .DataObjectHolder> {
    ...
    public ShoppingProductListAdapter(ArrayList<CartQuantity> myDataset, Activity context,
