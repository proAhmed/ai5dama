...
public class GetShoppingSubCategory extends AsyncTask<String, Void, ShoppingCategoryMain> {

	private   String URL =  "http://ai5adma.com/API/ar/product/categoriesbyparent/";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetShoppingSubCategory(Context context, OnLoadingComplete cb, double id) {
