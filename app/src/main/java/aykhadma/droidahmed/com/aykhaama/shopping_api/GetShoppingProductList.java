...
public class GetShoppingProductList extends AsyncTask<String, Void, ShoppingProductListMain> {

	private   String URL =  "http://ai5adma.com/API/ar/product/c/";

	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetShoppingProductList(Context context, OnLoadingComplete cb, int id) {
