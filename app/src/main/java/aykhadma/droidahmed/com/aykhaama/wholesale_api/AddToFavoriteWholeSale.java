...
public class AddToFavoriteWholeSale extends AsyncTask<Integer, Void, FavoriteResponse> {
	...
	public AddToFavoriteWholeSale(Context context, OnLoadingComplete cb) {
		dialog = new ProgressDialog(context);
		callback = cb;
		this.context = context;
		finalUrl = "http://ai5adma.com/API/ar/wswishlist/add?token="+new StoreData(context).getToken();
		Log.d("ooo",finalUrl);
	}
