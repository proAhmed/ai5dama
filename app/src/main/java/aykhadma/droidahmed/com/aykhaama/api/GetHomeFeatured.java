...
public class GetHomeFeatured extends AsyncTask<String, Void, FeatureResponse> {

	private   String URL =  "http://ai5adma.com/API/ar/home/featured";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetHomeFeatured(Context context, OnLoadingComplete cb) {
	...
	@Override
	protected FeatureResponse doInBackground(String... params) {
		...
		if (responseJSON != null && responseJSON.length() > 1) {
			...
			gson = gb.create();
			try {
				obj = gson.fromJson(responseJSON, FeatureResponse.class);
	...
	@Override
	protected void onPostExecute(FeatureResponse result) {
		if (dialog.isShowing()) {
			dialog.dismiss();
		}
		if (result != null) {
