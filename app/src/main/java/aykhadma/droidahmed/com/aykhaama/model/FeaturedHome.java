...
public class FeaturedHome {
    ...
    public FeaturedHome(int ID, int code, int categoryID, int brandID, double oldPrice, double price,
                        int quantity, String picture, ArrayList<String> sliderPictures, String createdDate, String modifiedDate,
                        int viewed, int featured, int state, int productID, int languageID, String name, String alias,
                        String contents, String description, String keywords) {
        this.ID = ID;
        Code = code;
    ...
    public FeaturedHome(int ID, int categoryID, int brandID, double oldPrice, double price, int quantity, String picture,
                        ArrayList<String> sliderPictures, String createdDate, String modifiedDate, int viewed, int featured, int state,
