 ...
 */
public class HomBottomImageAdapter extends RecyclerView
        .Adapter<HomBottomImageAdapter
        .DataObjectHolder> {
    private static String LOG_TAG = "MyRecyclerViewAdapter";
     private ArrayList<Integer> mDataset;
     Activity context;
    OnClickHomeBottom onClickHomeMenu;
    ...
    public HomBottomImageAdapter(ArrayList<Integer> myDataset, Activity context, OnClickHomeBottom onClickHomeMenu) {
        ...
        if (mDataset.size()>0) {
            ...
            holder.img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onClickHomeMenu.onBottomClick(position);
                }
            });
         }
